...
export default function ContactSection({ isLight }: { isLight: boolean }) {
    ...
    const contacts = [
        {
            label: 'johnatan.reiiss@icloud.com',
            href: 'mailto:johnatan.reiiss@icloud.com',
            external: false,
            icon: (
        ...
        {
            label: 'LinkedIn Santhiago',
            href: 'https://www.linkedin.com/in/johnatan-dos-santos-reis-945092b7/',
            external: true,
            icon: (
        ...
        {
            label: 'DevSanthiago',
            href: 'https://github.com/DevSanthiago',
            external: true,
            icon: (
                <svg className="w-full h-full" fill="currentColor" viewBox="0 0 24 24">
        ...
        {
            label: 'Dev Santhiago',
            href: 'https://www.instagram.com/devsanthiago?igsh=aG9iYW1mN3ZmeW1z&utm_source=qr',
            external: true,
            icon: (
                <svg className="w-full h-full" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="1.5">
                    <rect width="16" height="16" x="4" y="4" rx="4" strokeLinecap="round" strokeLinejoin="round" />
